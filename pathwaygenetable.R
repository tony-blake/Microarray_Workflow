makebeta1_pathwaygenetable <- function(indata){
  ...
  for(i in 1:length(testgenesinGOBP1)){
    ...
    tsymbolsforGOBP1[[i]] <- mget(testgenesinGOBP1[[i]], org.Hs.egSYMBOL)
...
makebeta3_pathwaygenetable <- function(indata){
  
  # Get list of genes in bph1
  bp1test <- make_beta3matrix2d(indata)
...
makebeta4_pathwaygenetable <- function(indata){
  
  # Get list of genes in bph1
  bp1test <- make_beta4matrix2d(indata)
...
makebeta5_pathwaygenetable <- function(indata){
  
  # Get list of genes in bph1
  bp1test <- make_beta5matrix2d(indata)
...
makebeta3down_pathwaygenetable <- function(indata){
  
  # Get list of genes in bph1
  bp1test <- makedown_beta3matrix2d(indata)
...
makebeta4down_pathwaygenetable <- function(indata){
  
  # Get list of genes in bph1
  bp1test <- makedown_beta4matrix2d(indata)
...
makebeta5down_pathwaygenetable <- function(indata){
  
  # Get list of genes in bph1
  bp1test <- makedown_beta5matrix2d(indata)
